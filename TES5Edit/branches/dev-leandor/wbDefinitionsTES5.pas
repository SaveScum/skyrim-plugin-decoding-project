  ...
  wbRecord(LVLI, 'Leveled Item', [
    ...
    wbRArrayS('Leveled List Entries',
      wbRStructExSK([0], [1], 'Leveled List Entry', [
        wbStructExSK(LVLO , [0, 2], [3], 'Base Data', [
          wbInteger('Level', itU16),
          wbByteArray('Unknown', 2, cpIgnore),LLCT,
    wbRArrayS('Leveled List Entries',
...
//             {0x000200 No Lnil{wbActorTemplateUseStats}),
      ...
      wbInteger('Speed Multiplier', itU16, nil, cpNormal, True, nil{wbActorTemplateUseStats}{0
      ...
      wbInteger('Magicka Offset', itU16, ninil{wbActorTemplateUseStats}),
    ...
    wbFormIDCk(RNAM, 'Race', [RACE], False, cpNormal, True, nil{wbActorTemplateUseTraits}it
    wbDEST,
    wbSPCT,
    wbSPLOs,
    wbFormIDCk(WNAM, 'Worn Armor', [ARMO], False, cpNormal, False),        {0x0001} 'Use Traits',
        {0x0002} 'Use Stats',
        {nil{wbActorTemplateUseTraits}),
...
//        'Use Stats',
//        'Use Factions',
//        'Use Actor Effect nil{wbActorTemplateUseAIPackages}ta
    wbKeywords,
    ...
    wbStruct(DNAM, 'Player Skills', [
      ...
      wbByteArray('Unknown', 3)
    ], cpNormal, False, nil{wbActorTemplateUseStatsAutoCalc}),Traits),
    wbFormIDCk(VTCK, 'Voice', [VTYP], False, cpNormal, False, wbActorTemplateUseTraitnil{wbActorTemplateUseModelAnimation}at
...
SoundLevelEnumCk(SPOR, 'Spectato
    wbCSDTs,
...
b  wbTints := wbRArray('Tint Masks', wbRStruct('Tint Assets', [
