  ...
  wbCTDA := wbRStruct('Conditions', [
    wbStruct(CTDA, 'Condition', [
      ...
      wbUnion('Parameter #1', wbCTDAParam1Decider, [
        ...
        wbFormIDCkNoReach('Object Reference', [PLYR, ACHR, REFR, PGRE, PHZD, PARW, PBAR, PBEA, PCON, PFLA]),
      ...
      wbUnion('Reference', wbCTDAReferenceDecider, [
        ...
        wbFormIDCkNoReach('Reference', [PLYR, ACHR, REFR, PGRE, PHZD, PARW, PBAR, PBEA, PCON, PFLA], True)
      ]),
...
b  wbRecord(NPC_, 'Non-Player Character', [
    wbEDIDReq,
    wbVMAD,
    wbOBNDReq,
...
//        'Use AI Data
  ...
  ], False, nil, cpNormal, False, wbNPCAfterLoad);bb  wbObjectTypeEnum := wbEnum([
          ' NONE',
          'Activators',
          'Armor',
          'Books',
